        ...
        {styles.map((s, i) => (
          <span
            ...
            style={{
              width: `${s.size}rem`,
              height: `${s.size}rem`,
              animation: `${s.animationName} 100s linear infinite`, // Longer duration for smoother transition
              boxShadow: "0px 0px 20px 10px rgba(101, 163, 13, 0.75)", // Significant light green shadow
            }}
          />
        ))}
